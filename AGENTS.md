...
OntoBQ compiles ontology-as-code Domain documents to BigQuery Property Graph. Tooling:
...
- Tests live under `src/ontobq/tests/` (colocated with the package)
